...
urlpatterns = [
    ...
    path("comment/create<int:news_id>", views.CreateCommentView.as_view(), name='create_comment'),
    path("comment/created_comment<int:news_id>", views.CreateCommentView.as_view(), name='create_comment'),
]